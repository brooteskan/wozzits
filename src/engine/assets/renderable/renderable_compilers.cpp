...
namespace wz::engine::assets::internal
{
        ...
        const EngineAssetContext& ctx)
    {
        ...
        // clipmap stack (a 0x70A CameraSnappedTerrain custom renderable +
        // ScalarField height + Placement). Intentionally NOT ported by the #195
        // scrap-and-rebuild; dies with #222. Kept for existing terrain content.
        registry.register_compiler(wz::asset::AssetCompiler{
