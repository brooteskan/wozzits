...
#include <engine/cognition/learning.h>  // reward
...
namespace wz::cognition
{
    ...
    {
        return wz::qstate::expectation_zz(reg, ctx_qubit, dec_qubit)
            - wz::qstate::expectation_z(reg, ctx_qubit)
                * wz::qstate::expectation_z(reg, dec_qubit);
    }
}
