...
namespace wz::engine::behavior
{
    namespace
    {
            ...
            wz::math::Vec3& out) noexcept
        {
            ...
            // small colliders (uniform scale < ~0.002, so SetWorldTranslation
            // silently no-ops under them) and accepted ill-conditioned large
            // ones; the NaN also slipped the bare gate. (C1-C27/29/34/42/49, #314)
